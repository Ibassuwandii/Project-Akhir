<x-module.comdev>
    ...
    <div class="card">
        <div class="card-header bg-primary text-white">
            <h4 class="card-title m-0"><b>Tambah Data Produksi Gula Tebu Site TNB</b></h4>
        </div>
        <div class="card-body">
            <form action="{{ url('comdev/site_tnb/produksitebu') }}" method="POST">
                @csrf
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nama_dusun') is-invalid @enderror" name="nama_dusun" id="nama_dusun"
                                placeholder="Masukkan Nama Dusun" value="{{ old('nama_dusun') }}" required>
                            @error('nama_dusun')
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('produksi') is-invalid @enderror" name="produksi" id="produksi"
                                placeholder="Masukkan Jumlah Produksi" value="{{ old('produksi') }}" required>
                            @error('produksi')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
