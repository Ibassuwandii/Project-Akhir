                    ...
                    <div class="card-header bg-primary text-white">
                        <div class="d-flex justify-content-between align-items-center">
                            <div style="padding-left: 20px;">
                                <h4 class="card-title m-0"><b>Data Pertanian Site TNB</b></h4>
                            </div>
                            <div>
                                <a href="{{ url('comdev/site_tnb/pertanian/create') }}" class="btn btn-success">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 2px">
                                            <div class="btn-group">
                                                <x-template.button.info-button url="comdev/site_tnb/pertanian" id="{{ $pertanian->id }}" />
                                                <x-template.button.edit-button url="comdev/site_tnb/pertanian" id="{{ $pertanian->id }}" />
