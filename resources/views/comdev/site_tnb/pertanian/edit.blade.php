<x-module.comdev>
    ...
    <div class="card">
        <div class="card-header bg-primary text-white">
            <h4 class="card-title m-0"><b>Edit Data Pertanian Site TNB</b></h4>
        </div>
        <div class="card-body">
            <form action="{{ url('comdev/site_tnb/pertanian/' . $pertanian->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nama_desa') is-invalid @enderror"
                                ...
                                value="{{ old('nama_desa', $pertanian->nama_desa) }}" required>
                            @error('nama_desa')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('komuditas') is-invalid @enderror"
                                ...
                                value="{{ old('komuditas', $pertanian->komuditas) }}" required>
                            @error('komuditas')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('luas_lahan') is-invalid @enderror"
                                ...
                                value="{{ old('luas_lahan', $pertanian->luas_lahan) }}" required>
                            @error('luas_lahan')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control @error('tanggal') is-invalid @enderror"
                                ...
                                value="{{ old('tanggal', $pertanian->tanggal ? $pertanian->tanggal->format('Y-m-d') : '') }}"
                                required>
                            @error('tanggal')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('hasil_sebelum') is-invalid @enderror"
                                ...
                                value="{{ old('hasil_sebelum', $pertanian->hasil_sebelum) }}" required>
                            @error('hasil_sebelum')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number"
                                ...
                                value="{{ old('jumlah_penerima_laki_laki', $pertanian->jumlah_penerima_laki_laki) }}"
                                required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number"
                                ...
                                value="{{ old('jumlah_penerima_perempuan', $pertanian->jumlah_penerima_perempuan) }}"
                                required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('hasil_target') is-invalid @enderror"
                                ...
                                value="{{ old('hasil_target', $pertanian->hasil_target) }}" required>
                            @error('hasil_target')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('hasil_akhir') is-invalid @enderror"
                                ...
                                value="{{ old('hasil_akhir', $pertanian->hasil_akhir) }}" required>
                            @error('hasil_akhir')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('keterangan') is-invalid @enderror" name="keterangan" id="keterangan"
                                placeholder="Masukkan Keterangan">{{ old('keterangan', $pertanian->keterangan) }}</textarea>
                            @error('keterangan')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="col-md-8 offset-md-4 d-flex justify-content-end">
                    <a href="{{ url('comdev/site_tnb/pertanian') }}" class="btn btn-secondary mr-2">
