<x-module.comdev>
    ...
    <div class="card">
        <div class="card-header bg-primary text-white">
            <h4 class="card-title m-0"><b>Tambah Data Perikanan Site PGSB</b></h4>
        </div>
        <div class="card-body">
            <form action="{{ url('comdev/site_pgsb/perikanan') }}" method="POST">
                @csrf
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nama_desa') is-invalid @enderror" name="nama_desa" id="nama_desa"
                                placeholder="Masukkan Nama Desa" value="{{ old('nama_desa') }}" required>
                            @error('nama_desa')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('komuditas') is-invalid @enderror" name="komuditas" id="komuditas"
                                placeholder="Masukkan Komuditas" value="{{ old('komuditas') }}" required>
                            @error('komuditas')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('luas_kolam') is-invalid @enderror" name="luas_kolam" id="luas_kolam"
                                placeholder="Masukkan luas kolam" value="{{ old('luas_kolam') }}" required>
                            @error('luas_kolam')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('hasil_sebelum') is-invalid @enderror" name="hasil_sebelum" id="hasil_sebelum"
                                placeholder="Masukkan Hasil Sebelum" value="{{ old('hasil_sebelum') }}" required>
                            @error('hasil_sebelum')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('jumlah_penerima_laki_laki') is-invalid @enderror" name="jumlah_penerima_laki_laki" id="jumlah_penerima_laki_laki"
                                placeholder="Masukkan Jumlah Penerima Laki-laki" value="{{ old('jumlah_penerima_laki_laki') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('jumlah_penerima_perempuan') is-invalid @enderror" name="jumlah_penerima_perempuan" id="jumlah_penerima_perempuan"
                                placeholder="Masukkan Jumlah Penerima Perempuan" value="{{ old('jumlah_penerima_perempuan') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('hasil_target') is-invalid @enderror" name="hasil_target" id="hasil_target"
                                placeholder="Masukkan Hasil Target" value="{{ old('hasil_target') }}" required>
                            @error('hasil_target')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('hasil_akhir') is-invalid @enderror" name="hasil_akhir" id="hasil_akhir"
                                placeholder="Masukkan Hasil Akhir" value="{{ old('hasil_akhir') }}" required>
                            @error('hasil_akhir')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="col-md-8 offset-md-4 d-flex justify-content-end">
                    <a href="{{ url('comdev/site_pgsb/perikanan') }}" class="btn btn-secondary mr-2">
