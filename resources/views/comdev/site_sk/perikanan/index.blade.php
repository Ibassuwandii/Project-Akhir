                ...
                <div class="">
                    <div class="card-header bg-primary text-white">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <a href="{{ url('comdev/site_sk/perikanan/create') }}" class="btn btn-success">
                            ...
                            <table id="example1" class="table table-bordered table-striped container-fluid" style="width: 100%;">
                                <thead class="bg-secondary text-white">
                                    <tr>
                                        ...
                                        <th style="padding: 6px" colspan="4" style="text-align: center">Jumlah Penerima Manfaat</th>
                                    </tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right" style="padding: 2px 20px 1px 1px;">{{ $perikanan->hasil_sebelum }}</td>
                                        <td class="text-right" style="padding: 2px 20px 1px 1px;">{{ $perikanan->hasil_target }}</td>
                                        <td class="text-right" style="padding: 2px 20px 1px 1px;">{{ $perikanan->hasil_akhir }}</td>
                                        <td class="text-left" >{{ $perikanan->keterangan}}</td>
                                        <td class="text-right" style="padding: 2px 20px 1px 1px;">{{ $perikanan->jumlah_penerima_laki_laki}}</td>
                                        <td class="text-right" style="padding: 2px 20px 1px 1px;">{{ $perikanan->jumlah_penerima_perempuan}}</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
