                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nama_desa') is-invalid @enderror"
                                ...
                                value="{{ old('nama_desa', $perikanan->nama_desa) }}">
                            @error('nama_desa')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('komuditas') is-invalid @enderror"
                                ...
                                value="{{ old('komuditas', $perikanan->komuditas) }}">
                            @error('komuditas')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('luas_kolam') is-invalid @enderror"
                                name="luas_kolam" id="luas_kolam" placeholder="Masukkan luas kolam"
                                value="{{ old('luas_kolam', $perikanan->luas_kolam) }}">
                            @error('luas_kolam')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('hasil_sebelum') is-invalid @enderror"
                                ...
                                value="{{ old('hasil_sebelum', $perikanan->hasil_sebelum) }}">
                            @error('hasil_sebelum')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('hasil_target') is-invalid @enderror"
                                ...
                                value="{{ old('hasil_target', $perikanan->hasil_target) }}">
                            @error('hasil_target')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('hasil_akhir') is-invalid @enderror"
                                ...
                                value="{{ old('hasil_akhir', $perikanan->hasil_akhir) }}">
                            @error('hasil_akhir')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number"
                                ...
                                value="{{ old('jumlah_penerima_laki_laki', $perikanan->jumlah_penerima_laki_laki) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number"
                                ...
                                value="{{ old('jumlah_penerima_perempuan', $perikanan->jumlah_penerima_perempuan) }}">
