<x-module.comdev>
    ...
    <div class="card">
        <div class="card-header bg-primary text-white">
            <h4 class="card-title m-0"><b>Tambah Data Rangkong Farm Site SK</b></h4>
        </div>
        <div class="card-body">
            <form action="{{ url('comdev/site_sk/rangkong') }}" method="POST">
                @csrf
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('nama_desa') is-invalid @enderror"
                           name="nama_desa" id="nama_desa" value="{{ old('nama_desa') }}" required>
                    @error('nama_desa')
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('luas_lahan') is-invalid @enderror"
                           name="luas_lahan" id="luas_lahan" value="{{ old('luas_lahan') }}" required>
                    @error('luas_lahan')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('komuditas') is-invalid @enderror"
                           name="komuditas" id="komuditas" value="{{ old('komuditas') }}" required>
                    @error('komuditas')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('hasil_sebelum') is-invalid @enderror"
                           name="hasil_sebelum" id="hasil_sebelum" value="{{ old('hasil_sebelum') }}" required>
                    @error('hasil_sebelum')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('hasil_target') is-invalid @enderror"
                           name="hasil_target" id="hasil_target" value="{{ old('hasil_target') }}" required>
                    @error('hasil_target')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('hasil_akhir') is-invalid @enderror"
                           name="hasil_akhir" id="hasil_akhir" value="{{ old('hasil_akhir') }}" required>
                    @error('hasil_akhir')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control @error('jumlah_penerima_laki_laki') is-invalid @enderror"
                           name="jumlah_penerima_laki_laki" id="jumlah_penerima_laki_laki" value="{{ old('jumlah_penerima_laki_laki') }}" required>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control @error('jumlah_penerima_perempuan') is-invalid @enderror"
                           name="jumlah_penerima_perempuan" id="jumlah_penerima_perempuan" value="{{ old('jumlah_penerima_perempuan') }}" required>
