<x-module.comdev>
    ...
    <div class="card">
        <div class="card-header bg-primary text-white">
            <h4 class="card-title m-0"><b>Tambah Data Patroli Karhutla</b></h4>
        </div>
        <div class="card-body">
            <form action="{{ url('comdev/site_sk/karhutla') }}" method="POST">
                @csrf
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('jangkauan_patroli') is-invalid @enderror"
                        name="jangkauan_patroli" id="jangkauan_patroli" value="{{ old('jangkauan_patroli') }}" required>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('jumlah_patroli') is-invalid @enderror"
                        name="jumlah_patroli" id="jumlah_patroli" value="{{ old('jumlah_patroli') }}" required>
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control @error('tanggal_patroli') is-invalid @enderror"
                        name="tanggal_patroli" id="tanggal_patroli" value="{{ old('tanggal_patroli') }}" required>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('titik_koordinat') is-invalid @enderror"
                        name="titik_koordinat" id="titik_koordinat" value="{{ old('titik_koordinat') }}" required>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('pemilik_lahan') is-invalid @enderror"
                        name="pemilik_lahan" id="pemilik_lahan" value="{{ old('pemilik_lahan') }}" required>
                    @error('pemilik_lahan')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('sosialisasi') is-invalid @enderror" name="sosialisasi" id="sosialisasi"
                        rows="4">{{ old('sosialisasi') }}</textarea>
                    @error('sosialisasi')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
